...
**No new event types.** The catalog is unchanged — verified against `packages/events/src/visibility-map.ts`: **81 total / 35 public / 46 internal**, same as Phase E.1a and every phase since.
