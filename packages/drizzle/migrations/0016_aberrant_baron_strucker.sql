...
CREATE UNIQUE INDEX "api_token_hmac_uidx" ON "api_token" USING btree ("token_hmac");--> statement-breakpoint
CREATE INDEX "api_token_user_idx" ON "api_token" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "api_token_org_idx" ON "api_token" USING btree ("organization_id");--> statement-breakpoint
...
CREATE INDEX "notification_feed_idx" ON "notification" USING btree ("user_id","created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "notification_dedup_uidx" ON "notification" USING btree ("user_id","dedup_key") WHERE "notification"."dedup_key" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "notification_email_pending_idx" ON "notification" USING btree ("email_pending_at") WHERE "notification"."email_sent_at" IS NULL AND "notification"."email_pending_at" IS NOT NULL;--> statement-breakpoint
CREATE INDEX "notification_sweep_idx" ON "notification" USING btree ("created_at") WHERE "notification"."read_at" IS NOT NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "notification_preference_uidx" ON "notification_preference" USING btree ("scope","scope_id","category","channel");--> statement-breakpoint
