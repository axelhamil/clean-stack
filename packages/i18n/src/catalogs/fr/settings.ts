export default {
  ...
  apiTokens: {
    ...
    newTokenAction: "Nouveau jeton",
    loading: "Chargement…",
    loadFailed: "Échec du chargement des jetons API.",
    empty: "Aucun jeton pour l'instant. Créez-en un pour commencer.",
    createdToast: "Jeton créé",
    revokedToast: "Jeton révoqué",
    createDialogTitle: "Créer un jeton API",
    createAction: "Créer",
    secretDialogTitle: "Jeton API",
    table: {
      nameHeader: "Nom",
      tokenHeader: "Jeton",
      ...
      statusHeader: "Statut",
      tokenScopeHeader: "Portée du jeton",
    },
    ...
    form: {
      ...
      namePlaceholder: "Mon application",
      scopesLabel: "Portées",
      tokenScopeLabel: "Portée du jeton",
      personalOption: "Personnel",
      expiryLabel: "Expiration",
    },
    expiryDays_one: "{{count}} jour",
    expiryDays_other: "{{count}} jours",
    expiryYears_one: "{{count}} an",
